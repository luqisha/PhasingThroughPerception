...
//void iShowImageSmart(int x, int y, unsigned int texture)
//{
//
//	int width, height;
//	glEnable(GL_TEXTURE_2D);
...
void iShowImageSmart(int x, int y, unsigned int texture, double ratio=1)
{
	...
	glTexCoord2f(1, 0);
	glVertex2f(x + (double)width/ratio, y);

	glTexCoord2f(1, -1);
	glVertex2f(x + (double)width/ratio, y + (double)height/ratio);

	glTexCoord2f(0, -1);
	glVertex2f(x, y + (double)height/ratio);
